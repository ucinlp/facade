...
def argument_parsing():
    ...
    parser.add_argument(
        "--attack_target",
        type=str,
        choices=["question", "passage"],
        help="Whether you want to attack the question or the passage",
    )
