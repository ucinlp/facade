...
def main():
    ...
    fine_tuner = Bios_FineTuner(model, reader, train_data, dev_data, vocab, args, regularize=True)
    fine_tuner.finetune()
...
def argument_parsing():
    ...
    parser.add_argument('--normalization2', deafult='l1', type=str, help='L2 norm or l2 norm')
