...
def load_data(data_file):
    ...
    len_rows = [
        create_df(data[0], "NLI Baseline", "Original"),
        create_df(data[1], "NLI Baseline", "Reduced"),
        create_df(data[2], "NLI Combined", "Original"),
        create_df(data[3], "NLI Combined", "Reduced")
    ]
